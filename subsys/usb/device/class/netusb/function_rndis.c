...
USBD_CLASS_DESCR_DEFINE(primary, 0) struct usb_rndis_config rndis_cfg = {
	.iad = {
		...
		.bFunctionClass = 0xE0, //USB_BCC_CDC_CONTROL,
		.bFunctionSubClass = 0x01, // 6,
		.bFunctionProtocol = 0x03, //0,
		.iFunction = 0,
	},
	...
	.if0 = {
		...
		.bAlternateSetting = 0,
		.bNumEndpoints = 1,
		.bInterfaceClass = 0xE0, //USB_BCC_CDC_CONTROL,
		.bInterfaceSubClass = 0x01, //ACM_SUBCLASS,
		.bInterfaceProtocol = 0x03, //ACM_VENDOR_PROTOCOL,
		.iInterface = 0,
	},
